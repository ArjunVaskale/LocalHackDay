...
--
-- Host: localhost
-- Generation Time: Dec 02, 2018 at 01:59 PM
...
INSERT INTO `college` (`username`, `password`) VALUES
('admin', 'root');
--
-- Database: `chat`
--
...
INSERT INTO `chat_table` (`name`, `message`, `time`, `username`, `password`, `email`) VALUES
('', '', '00:00:00.000000', 'arjun', 'arjun', 'arjun@gmail.com');
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"chat\",\"table\":\"chat_table\"},{\"db\":\"arjun\",\"table\":\"college\"}]');
...
('root', '2018-12-02 12:57:24', '{\"Console\\/Mode\":\"show\"}');
